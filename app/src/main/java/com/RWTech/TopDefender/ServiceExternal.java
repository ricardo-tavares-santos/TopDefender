...
public class ServiceExternal extends IntentService {
    private static final String TAG = "TopDefender.External";
    private static final String ACTION_DOWNLOAD_HOSTS_FILE = "com.RWTech.TopDefender.DOWNLOAD_HOSTS_FILE";

    // am startservice -a com.RWTech.TopDefender.DOWNLOAD_HOSTS_FILE
