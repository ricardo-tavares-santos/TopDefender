package com.RWTech.TopDefender;
...
public class ActivityMain extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    private static final String TAG = "TopDefender.Main";
    ...
    public static final String ACTION_RULES_CHANGED = "com.RWTech.TopDefender.ACTION_RULES_CHANGED";
    public static final String ACTION_QUEUE_CHANGED = "com.RWTech.TopDefender.ACTION_QUEUE_CHANGED";
...
/*
            case R.id.menu_apps:
                startActivity(getIntentRWStudio());
                //menu_apps();
                return true; */
    ...
    private static Intent getIntentPro(Context context) {
        if (Util.isPlayStoreInstall(context))
            ...
            intent.setData(Uri.parse("https://play.google.com/store/apps/dev?id=9136344507301992991"));
            return intent;
        }
    }
    ...
    private static Intent getIntentInvite(Context context) {
        ...
        intent.putExtra(Intent.EXTRA_TEXT, context.getString(R.string.msg_try) + "\n\nhttps://play.google.com/store/apps/dev?id=9136344507301992991\n\n");
        return intent;
    }

    private static Intent getIntentApps(Context context) {
        return new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/dev?id=9136344507301992991"));
    }

    private static Intent getIntentRW() {
        Intent intent = new Intent(Intent.ACTION_VIEW);
       // intent.setData(Uri.parse("https://play.google.com/store/apps/dev?id=8661706558284396298"));
        intent.setData(Uri.parse("market://search?q=RWdesenv"));
        return intent;
    }
    private static Intent getIntentRWStudio() {
        Intent intent = new Intent(Intent.ACTION_VIEW);
        intent.setData(Uri.parse("https://play.google.com/store/apps/dev?id=7003053749192026050"));
        return intent;
    }
